 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.30.0 (build adae23f)", date = "2021-06-28T03:55:36.104Z")
...
public interface SubjectAccessReviewSpec extends software.amazon.jsii.JsiiSerializable {
    ...
    public static final class Builder implements software.amazon.jsii.Builder<SubjectAccessReviewSpec> {
        ...
        /**
         * Sets the value of {@link SubjectAccessReviewSpec#getGroup}
        ...
        public SubjectAccessReviewSpec build() {
            return new Jsii$Proxy(extra, group, nonResourceAttributes, resourceAttributes, uid, user);
        }
    }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements SubjectAccessReviewSpec {
         ...
         */
        @SuppressWarnings("unchecked")
        protected Jsii$Proxy(final java.util.Map<java.lang.String, ? extends java.util.List<java.lang.String>> extra, final java.util.List<java.lang.String> group, final imports.k8s.NonResourceAttributes nonResourceAttributes, final imports.k8s.ResourceAttributes resourceAttributes, final java.lang.String uid, final java.lang.String user) {
