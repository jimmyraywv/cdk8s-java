 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.30.0 (build adae23f)", date = "2021-06-28T03:55:35.905Z")
...
public interface Initializers extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    default @org.jetbrains.annotations.Nullable imports.k8s.KubeStatusProps getResult() {
        return null;
    }
    ...
    public static final class Builder implements software.amazon.jsii.Builder<Initializers> {
        ...
        private imports.k8s.KubeStatusProps result;
         ...
         * @return {@code this}
         */
        public Builder result(imports.k8s.KubeStatusProps result) {
            this.result = result;
            return this;
        }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements Initializers {
        ...
        private final imports.k8s.KubeStatusProps result;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            ...
            this.result = software.amazon.jsii.Kernel.get(this, "result", software.amazon.jsii.NativeType.forClass(imports.k8s.KubeStatusProps.class));
        }
         ...
         */
        @SuppressWarnings("unchecked")
        protected Jsii$Proxy(final java.util.List<? extends imports.k8s.Initializer> pending, final imports.k8s.KubeStatusProps result) {
        ...
        @Override
        public final imports.k8s.KubeStatusProps getResult() {
            return this.result;
        }
