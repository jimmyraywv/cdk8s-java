 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.30.0 (build adae23f)", date = "2021-06-28T03:55:36.091Z")
...
public interface ReplicaSetSpec extends software.amazon.jsii.JsiiSerializable {
    ...
    public static final class Builder implements software.amazon.jsii.Builder<ReplicaSetSpec> {
         ...
         * @param selector Selector is a label query over pods that should match the replica count.
         *                 If the selector is empty, it is defaulted to the labels present on the pod template. Label keys and values that must match in order to be controlled by this replica set. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/labels/#label-selectors
         * @return {@code this}
         */
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements ReplicaSetSpec {
         ...
         */
        protected Jsii$Proxy(final java.lang.Number minReadySeconds, final java.lang.Number replicas, final imports.k8s.LabelSelector selector, final imports.k8s.PodTemplateSpec template) {
